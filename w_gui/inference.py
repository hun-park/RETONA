...
def app(train_path,label_path,class_path,threads,model):
    ...
    for i in range(len(out_q)):
        ...
        if (ground_truth==prediction):
            correct += 1
            print('Correct:%4d, Prediction:%2d, Ground_truth:%2d' %(correct,prediction,ground_truth))
        else:
            wrong += 1
            print('Wrong  :%4d, Prediction:%2d, Ground_truth:%2d' %(wrong,prediction,ground_truth))
...
def inference(data_path,class_path,threads,model):
    ...
    print("Inference data is done")
    return classes[out_q[0]]
